...
| **`soul_land_3_new/`** | Branch — **NEW Soul Land 3 serial** (separate from the Lin Hao branch; relation pending author Ruling R2, default: separate universe) — 🔴 **FOUNDATION COMPLETE 2026-09-22: zero chapters, drafting locked until rulings R1–R4** | `README.md` · `HANDOFF.md` · `foundation/` (`RAILS.md`, `OPEN_RULINGS.md` R1–R6, `CANON_SPINE_SL3.md`, `POWER_LAW_SL3.md`, `KNOWLEDGE_FIREWALLS.md`, `STATUS_PANEL.md`, `CANON_LEDGER.md`, `SERIAL_LOG.md`) · `seeds/PREMISE_CANDIDATES.md` (P1–P6) · `codex/` · `checks/` (**`sh checks/run_all.sh`: gate selftest 10/10 + verify must exit 0**) |

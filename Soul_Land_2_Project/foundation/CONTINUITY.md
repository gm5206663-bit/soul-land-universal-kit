# CONTINUITY — anchors and debts
### Soul Land 2 · The Unraveled Tide. Updated 2026-09-20 (re-rail).

## Anchor table (the clock)

| Anchor | Value | Source |
|---|---|---|
| Story year | the year of Huo Yuhao's birth (SL2 opening) | codex (v2.0 correction ledger) |
...
## Rules that keep the anchors honest
1. One source of truth per topic — rank lives in the codex "Ranks:" lines and
   `STATUS_PANEL.md`, nowhere else.
2. Append is not an update — refresh the core rows; when rot is found in one
   doc, sweep the siblings for the same disease (this re-rail did exactly that).
3. No chapter is written before the author's go; no debt is closed off-page.

...
- Word count (body): 3,284 (verify.py, s37 gate). Spoken dialogue: 32 lines (9.8 per 1000w). Prose metrics (s35 house-grammar method, prose-only): average 17.5w, median 13w, longest 55w; no sentence over 60w; motif word "the way" x0.

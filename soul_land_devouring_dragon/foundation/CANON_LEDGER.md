...
| ER-11 | THE BORDERS' RING ECONOMY: the road market at the mountain's foot pays for rings; the TANG SECT'S FRONTIER TEAMS buy rings there (the Tang Sect at the height of its legend, ER-02); prices stay at dialogue-folk level (the corpus law); the ring-hunting line's plan: the grey stag's PURPLE RING as Old Qin's SECOND RING (ch11), the old bull's PURPLE RING as Xiao An's FIRST RING (ch12 — a thousand-year first ring; the canon tension of the high-tier first ring: it either makes the soul or breaks it — the risk of a high-tier ring on a lower frame is the canon pattern) | WORLD §4–5 (design-folk) + ER-02 (canon) + ring-tier/skill canon (SB-02, SPIRIT_BEAST_LORE_VERIFIED §2: a soul ring contains all the beast's cultivation + its innate ability) | design-folk under canon |

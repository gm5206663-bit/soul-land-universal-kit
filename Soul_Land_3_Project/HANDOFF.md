...
5. **`LIN_HAO_BODY_AND_SOULS.md`** — the readable card of what he IS: the Deep-Water appearance stage, both spirit ages (hawk 3,199 · jiao 12,210), the Storm Body stations, the gifts ledger, the skills state, the bond law, and a ch102 preview passage.
6. This file's §3–§6 (pipeline + laws that postdate the CONTINUATION_PROMPT).
...
- **(v2.56) THE APPEARANCE LAW (LOCKED):** appearance is a progression line, audited like rank; three consecutive chapters with no on-page appearance/mutation beat = suite failure. **Enforced at source by `checks/prose_floor.py` P2 (Layer 1b, epoch ch67)** — do NOT duplicate it. (BG1, 09-03: a false "never enforced" alarm — grep the checkers before declaring an enforcement gap.) **The MUTATION ladder now has its next stage designed: see THE DEEP-WATER STAGE below.**
- **(BH1–BH5) THE LIVING-PRESENCE LAWS (09-03, user catch: "mutations completely stop… soul skills completely ignored… bond not showing"):** named things may not go quiet — **skills** on-page within 12 ch (measured at catch: Wind-Step 47 ch silent, Gale Talon 32) · **LH↔Wulin two-hander** (bond vocabulary live) ≤5 ch · **ensemble rotation** (each of the four in prose ≤3 ch) · **mutation-stage vocabulary** ≤10 ch. Enforced by **Layer 9 R6**; a silent-but-owed line must carry a BH debt in PROBLEM_INVENTORY or the suite fails. **The creation package locked the same day:** **THE DEEP-WATER STAGE** (THE_CODEX §The Deep-Water Stage — the post-jiao appearance canon: lengthened frame [the "looks ~16" is LENGTH, the face stayed thirteen] · the cold line [breath fogs in cold rooms, cold water unregistered, frost beads and slides] · glacier-green eye-ring in ice-light · scale-TRACE sheen at the marks, never scales · the near-silver strand · deep-water regeneration · the v2.56-owed stages delivered) · **THE STORM BODY** (POWER_MODEL §The Storm Body — the body NAMED, the fourth column of his existence, stations audited like rank; on-page naming is a staged beat, never fiated) · **THE SECOND SPIRIT LINE** (POWER_MODEL §The Second Spirit Line — the jiao COUNTED: **12,000 at the ch68 bond → 12,210 at ch101**, the +210 documented; grows by DEPTH per the session-t law; the hawk's dragonward tendency locked — pinfeather sheen, the not-a-bird note — separate from the held "what answered the hawk"; the jiao's NAME = a staged beat, the Goldsong mirror).
...
**Lin Hao’s appearance (the prose record — writer’s card):** extremely handsome — ch1, age six: “already the reason two older women had stopped in the street to ask his mother whether he was something to do with the theatre”; ch19: “Ah. You’re very good looking.” (+ the cheek-pinch the road talked about for a term); ch101: “Because he’s handsome.” / “WAY handsomer than you.” · **Hair: dark brown, slightly wavy, short, playful-messy** (ch1) — storm-light tips visible from ch8 (“a dozen storm-light tips”), the second-years calling it “the weather” (ch12), the whole lane seeing it after the tournament (ch13) — **the left-temple lock gone storm-gray ON-PAGE ch35**, the towel coming away damp “because the hair had a breeze in it” (the permanent breeze, ch20) — **the ch40 crossing ESCALATED the mutations** (they jump; the hair is the most visible change) — **hawk-gold at the temple and in the hair, “the colour of the sword”** (ch62-era note, current) · eyes amber-brown, gold-flecked in strong light, reading air-currents · in combat, wind-patterns like feather-marks across shoulders/back; the forearm marks raised (ch62) · lean-athletic, iron-dense, **looks ~16 at thirteen.** The mutation ladder escalates with the hawk (THE_CODEX §Appearance & Mutation Law, LOCKED).

**OWED IN CH102 (the BH payment list — all five land naturally at a registration morning):** (1) **the Deep-Water reveal** through new Shrek eyes — the lengthened frame, the streak-work, the silver strand, the glacier-green ring in water-light — with at least one reaction ALOUD (BH1 + the BG1 residue); (2) **Gale Talon + one sword-line skill spent on-page** (BH4 — Wind-Step at 47 ch silent is the deeper debt, pay it by ch103); (3) **the footer state line carries "hawk 3,199 · jiao 12,210" and names the Storm Body's station** (BH2/BH3); (4) **an LH↔Wulin two-hander** with the bond's own vocabulary (BH5); (5) Xiaoyan present in prose (R6-c). The ch101 cliff was long-lyrical — rotate. Expect Bun-adjacent dining-hall texture per the title.

...
# ---------------- CH75 ----------------
patch('chapters/chapter_75.md', [
 ('"Get in." Xie Xie tried the back and was promptly dragged out and forced to the front by Gu Yue, which left Lin Hao beside him, and the back seat arranged by the same invisible hand — Xiaoyan at one window laughing into her hand, Wulin at the other, Gu Yue in the middle. *Too controlling,* Xie Xie cursed silently. *Hogging Wulin all to herself.* Nobody in the car was deceived by anybody\'s face.',
 ...
 ('A juice box appeared against Wulin\'s arm at the second traffic bridge. His heart warmed at it, and he smiled at her, and drank it, and happiness flashed through Gu Yue\'s eyes before she closed them to rest, and the two of them sat shoulder-to-shoulder, her cool arm against his warm one, in an atmosphere the front seat could feel the temperature of and had the manners not to report.',
 ...
 ('"That\'s fine. Our captain is great at making money."; "What work?"** — canon ch 253, verbatim.',
  '"That\'s fine. Our captain is great at making money."; "What work?"** — canon ch 253, verbatim **except the RECEIVER: the seat arrangement and the juice box are RE-RECEIVERED to Lin Hao (the Receiver Law, session oo — canon\'s pairing beat does not exist in this AU).**'),
 ('the bond line kept, the estrangement dropped. The wire stays dormant: the juice box and the flashing happiness are canon\'s own, uninterpreted, the front seat unreporting.',
  'the bond line kept, the estrangement dropped. **THE RECEIVER LAW (session oo, user ruling): the juice box and the seat arrangement were canon\'s Wulin×Gu Yue beat — a pairing that DOES NOT EXIST in this AU. Both re-receivered to Lin Hao. The old "wire dormant / uninterpreted" copy-rule is REPEALED — it was the door canon got copied through.**'),
 ('**front seat by force; "What work?" standing (canon 253\'s cliff)**',
  '**back seat by force (the front taken beside Lin Hao); "What work?" standing (canon 253\'s cliff)**'),
])
...
patch('chapters/chapter_79.md', [
 ...
 ('The gigantic blade plunged down at them.\n\nGu Yue shut her eyes and wrapped her arms around',
  'The gigantic blade plunged down at them.\n\nGu Yue shut her eyes and wrapped her arms around'),
...
t = io.open('CODEX/05_PROJECT_SOUL_LAND_3.md', 'w', encoding='utf-8')
t.write(io.open('THE_CODEX.md', encoding='utf-8').read()); t.close()
print('mirror synced')

# leftover sweep
import glob
bad = []
for f in glob.glob('chapters/*.md') + ['RELATIONSHIPS.md','THE_CODEX.md','CHARACTER_STATS.md','CONTINUATION_PROMPT.md','BUTTERFLY_REGISTRY.md','LIN_HAO_STATUS.md','POWER_MODEL.md']:

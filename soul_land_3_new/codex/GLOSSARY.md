# GLOSSARY — the serial's vocabulary, chosen once, never drifted (spine §6)

This serial uses these English renderings. Editing an entry = updating it HERE
and nowhere else, then fixing every chapter (two-copies law applied to words).

| Term we write | Meaning |
|---|---|
| soul power | spiritual energy measure, ranks 1–100 |
| martial soul | the soul awakened at six |
| spirit soul | this era's ring-source (Pagoda-grown) |
| Spirit Pagoda | the spirit-soul monopoly organization |
| Spirit Ascension Platform | its age-raising space |
| battle armor | personal armor-system, one- to four-word |
| mecha | mass military machine class, white→red |
| fusion forging | alloy craft; harmony % metric |
| Saint Craftsman | 8★ blacksmith (Divine = 9★) |
| Titled/Super/Limit Douluo | 91–94 / 95–98 / 98–99 |
